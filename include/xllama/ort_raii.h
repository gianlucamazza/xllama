...
struct OgaModelDeleter          { void operator()(OgaModel* p)           const noexcept { OgaDestroyModel(p); } };
struct OgaTokenizerDeleter      { void operator()(OgaTokenizer* p)       const noexcept { OgaDestroyTokenizer(p); } };
struct OgaTokenizerStreamDeleter{ void operator()(OgaTokenizerStream* p) const noexcept { OgaDestroyTokenizerStream(p); } };
struct OgaGeneratorParamsDeleter{ void operator()(OgaGeneratorParams* p) const noexcept { OgaDestroyGeneratorParams(p); } };
struct OgaGeneratorDeleter      { void operator()(OgaGenerator* p)       const noexcept { OgaDestroyGenerator(p); } };
struct OgaSequencesDeleter      { void operator()(OgaSequences* p)       const noexcept { OgaDestroySequences(p); } };
struct OgaResultDeleter         { void operator()(OgaResult* p)          const noexcept { OgaDestroyResult(p); } };
