...
| --- | --- | --- | --- | ---: | ---: | :---: | ---: | --- |
| LFM2.5-350M | 350M | Q4_K_M | llama.cpp CPU · t6 | 241.4 | **94.2** | _single run_ | 321 | `phase5-gguf` |
| Gemma-3-270M | 270M | Q4_K_M | llama.cpp CPU · t6 | 395.0 | **76.8** | _single run_ | 368 | `phase6-gemma` |
| SmolLM2-360M | 360M | int4 | ORT-GenAI CPU | 219.8 | **68.0** | _single run_ | 722 | `phase2-dml` |
