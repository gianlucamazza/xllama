...
| Demo / screenshot capture and presentation edit                                        | [`../scripts/capture-demo-video.sh`](../scripts/capture-demo-video.sh) + [`../scripts/edit-demo-video.sh`](../scripts/edit-demo-video.sh) + [`./screenshots/`](./screenshots/) |
