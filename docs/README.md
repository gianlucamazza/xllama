...
| [training-architecture.md](./training-architecture.md)           | **Training SSOT**: reverse-engineering inventory, capability matrix, lanes A/B/C, hybrid preference loop                                     |
| [../training/README.md](../training/README.md)                   | Training ops: job JSON, host PEFT runner, stages                                                                                             |
