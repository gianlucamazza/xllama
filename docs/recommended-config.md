...
| --------------------- | -------------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Default (unified)** | `lfm25-350m`               | llama.cpp (`unified`) | **89.7 tok/s** median (88.7–91.0; current Series S capture, recommended)                                                                                                                                                                                |
...
| **Fast modern GGUF**  | `lfm25-350m`               | llama.cpp (`unified`) | 89.7 tok/s median (441.0 prefill, t6, `n_ctx=2048`; 3 recorded runs in `phase17-console-2026-08-26`)                                                                                                                                                    |
