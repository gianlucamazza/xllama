...
void MainPage::InitializeComponent() {
    ...
    ::winrt::Windows::UI::Xaml::Application::LoadComponent(
        *this,
        ::winrt::Windows::Foundation::Uri(L"ms-appx:///MainPage.xaml"),
...
void MainPage::Connect(int32_t connectionId,
    ...
    switch (connectionId) {
    case 1: ModelText(target.as<::winrt::Windows::UI::Xaml::Controls::TextBlock>()); break;
    case 2: StatusText(target.as<::winrt::Windows::UI::Xaml::Controls::TextBlock>()); break;
    case 3: LoadingBar(target.as<::winrt::Windows::UI::Xaml::Controls::ProgressBar>()); break;
    case 4: OutputScroll(target.as<::winrt::Windows::UI::Xaml::Controls::ScrollViewer>()); break;
    case 5: PromptInput(target.as<::winrt::Windows::UI::Xaml::Controls::TextBox>()); break;
    case 6: OutputText(target.as<::winrt::Windows::UI::Xaml::Controls::TextBlock>()); break;
    case 7: MetricsText(target.as<::winrt::Windows::UI::Xaml::Controls::TextBlock>()); break;
    case 8: RunButton(target.as<::winrt::Windows::UI::Xaml::Controls::Button>()); break;
    case 9: CancelButton(target.as<::winrt::Windows::UI::Xaml::Controls::Button>()); break;
    }
}
