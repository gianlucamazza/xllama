...
| `results/phase15-gpugemv-h62.csv`                  | 15    | D3D12 Q4_K GEMV (Series S)      | H6.2 wave32 + naive A/B (measure in flight). Contents land with the console CSV; do not invent `packed_gbs`. G2 stays 40, K1=8. `scripts/bench-gpugemv.sh` default `--out`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
