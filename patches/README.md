...
| File                                        | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `0001-uwp-appcontainer-guards.patch`        | Guard the Win32 desktop-only APIs with `WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP)` across **4 files**: the registry CPU-name lookup (`ggml-cpu.cpp`), `SetThreadAffinityMask` and `SetThreadInformation(ThreadPowerThrottling)` (`ggml-cpu.c` — AppContainer falls back to the system scheduler), `dl_load_library`/`dl_get_sym` re-implemented via `LoadPackagedLibrary` (`ggml-backend-dl.cpp`), and the Win32 mmap/mlock impls plus `llama_mmap::SUPPORTED` / `llama_mlock::SUPPORTED` (`src/llama-mmap.cpp`).                                                                                                                                               |
